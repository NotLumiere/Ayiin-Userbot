...
@ayiinCmd(pattern=r"slap(?: |$)(.*)")
async def _(event):
    """slaps a user, or get slapped if not a reply."""
    replied_user = await ayiin.getUserFromEvent(event)
    if replied_user:
...
@ayiinCmd(pattern=r"(yes|no|maybe|decide)$")
async def _(event):
...
@ayiinCmd(pattern=r"fp$")
async def _(palm):
    """Facepalm  🤦‍♂"""
    await palm.edit("🤦‍♂")


@ayiinCmd(pattern=r"cry$")
async def _(e):
    """y u du dis, i cry everytime !!"""
    await e.edit(choice(CRI))


@ayiinCmd(pattern=r"insult$")
async def _(e):
    """I make you cry !!"""
    await e.edit(choice(INSULT_STRINGS))


@ayiinCmd(pattern=r"cp(?: |$)(.*)")
async def _(cp_e):
...
@ayiinCmd(pattern=r"hi$")
async def _(hello):
    """Greet everyone!"""
    await hello.edit(choice(HELLOSTR))


@ayiinCmd(pattern=r"owo(?: |$)(.*)")
async def _(owo):
    """UwU"""
...
@ayiinCmd(pattern=r"react$")
async def _(react):
    """Make your userbot react to everything."""
    await react.edit(choice(FACEREACTS))


@ayiinCmd(pattern=r"shg$")
async def _(shg):
    r"""¯\_(ツ)_/¯"""
    await shg.edit(choice(SHGS))


@ayiinCmd(pattern=r"chase$")
async def _(chase):
    """Lari bro lari, aku akan segera menangkapmu !!"""
    await chase.edit(choice(CHASE_STR))


@ayiinCmd(pattern=r"run$")
async def _(run):
    """Lari, lari, LARIII!"""
    await run.edit(choice(RUNS_STR))


@ayiinCmd(pattern=r"metoo$")
async def _(hahayes):
    """Haha yes"""
    await hahayes.edit(choice(METOOSTR))


@ayiinCmd(pattern=r"oem$")
async def _(e):
    t = "Oem"
    for _ in range(16):
        t = t[:-1] + "em"
...
@ayiinCmd(pattern=r"10iq$")
async def _(e):
    await e.edit("♿")


@ayiinCmd(pattern=r"fuck$")
async def _(e):
    await e.edit(".                       /¯ )")
    await e.edit(".                       /¯ )\n                      /¯  /")
    await e.edit(
...
async def _(event):
    ...
    if len(args) == 0:
        ...
        await eod(event, "**Masukan jumlah detik yang benar !!**", 120)
        return
    try:
        if scam_time > 0:
            await event.delete()
...
@ayiinCmd(pattern=r"tai$")
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("\n{\\__/}" "\n(●_●)" "\n( >💩 Mau Tai Ku?")


@ayiinCmd(pattern=r"paw$")
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`(=ↀωↀ=)")


@ayiinCmd(pattern=r"tf$")
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("(̿▀̿ ̿Ĺ̯̿̿▀̿ ̿)̄  ")


@ayiinCmd(pattern=r"gey$")
async def _(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "`\n┈┈┈╭━━━━━╮┈┈┈┈┈\n┈┈┈┃┊┊┊┊┊┃┈┈┈┈┈`"
...
@ayiinCmd(pattern=r"(?:penis|dick)\s?(.)?")
async def _(e):
